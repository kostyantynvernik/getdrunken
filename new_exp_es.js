(function() {
var targetUrl = '/es/pages/builder'; 
...
<div style="padding-top: 25px;"><table style="width:100%;border:none !important;margin-bottom: 0 !important;"><tr><td style="border-right: 0 !important;text-align: center;" class="indertopmaindci"><div><img style="width: 50px;display: inline;padding-bottom:10px" src="https://raw.githubusercontent.com/kostyantynvernik/getdrunken/refs/heads/main/Frame%20543.png"></div><div>Entrega en toda la isla</div></td>
<td style="border-right: 0 !important;text-align: center;" class="indertopmaindci"><div><img style="width: 43px;display: inline;padding-bottom:10px" src="https://raw.githubusercontent.com/kostyantynvernik/getdrunken/refs/heads/main/Group.png"></div><div>Horneado en Puerto Rico</div></td>
<td style="border-right: 0 !important;text-align: center;" class="indertopmaindci"><div><img class="ssss1" style="width: 40px;padding: 0 5px 10px 0;display: inline;" src="https://raw.githubusercontent.com/kostyantynvernik/getdrunken/refs/heads/main/Vector.png"></div><div>Recién horneado diariamente</div></td></tr></table>
</div>`);


document.querySelectorAll('.builder-summary__footer button')[0].insertAdjacentHTML('afterend', '<button type="button" class="atc-btn cta--custom cta--custom-second atc-btn-disabled">Añadir a la cesta</button>');;
...
if (/(\d+)\s*PIEZA?/i.test(text)) {
var newText = text.replace(/(\d+)\s*PIEZA?/i, '$1X');
